...
/**Type of the result value for SciterUI DOM functions.
 * Possible values are:
 ...
 * \param[in] hwnd \b HWINDOW, SciterUI window for which you need to get root
 * element
 ...
 * \param[in] hwnd \b HWINDOW, SciterUI window for which you need to get focus
 * element
 ...
 * \param[in] hwnd \b HWINDOW, SciterUI window for which you need to find
 * elementz
 ...
 * element relative to SciterUI window, otherwise the location is given
...
{
  ROOT_RELATIVE = 0x01,       // - or this flag if you want to get SciterUI window relative coordinates,
  ...
  VIEW_RELATIVE = 0x04,       // - position relative to view - SciterUI window
 ...
 * \param[in] hwnd \b HWINDOW, HWINDOW of SciterUI window
 * \param[in] uid \b UINT
 ...
 * \param[in] hePopup \b HELEMENT, element to show as popup
 * \param[in] pos \b POINT, popup element position, relative to origin of SciterUI window.
